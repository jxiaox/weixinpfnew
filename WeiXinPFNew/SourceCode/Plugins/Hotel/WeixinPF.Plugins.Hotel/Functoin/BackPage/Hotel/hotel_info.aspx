<%@ Page Language="C#" AutoEventWireup="true" Async="true" ValidateRequest="false" CodeBehind="hotel_info.aspx.cs" Inherits="WeixinPF.Hotel.Plugins.Functoin.BackPage.Hotel.hotel_info" %>
...
<head id="Head1" runat="server">
    ...
    <title></title>
    <script type="text/javascript" src="../../../Common/jquery/jquery-2.1.0.min.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".upload-img").each(function () {
                $(this).InitSWFUpload({ sendurl: "../Admin/tools/upload_ajax.ashx", flashurl: "../../../Common/swfupload/swfupload.swf" });
            });
            $(".upload-album").each(function () {
                $(this).InitSWFUpload({ btntext: "批量上传", btnwidth: 66, single: false, water: true, thumbnail: true, filesize: "2048", sendurl: "../Admin/tools/upload_ajax.ashx", flashurl: "../../../Common/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;" });
            });
            ...
            var editor = KindEditor.create('.editor', {
                ...
                height: '350px',
                resizeType: 1,
                uploadJson: '../Admin/tools/upload_ajax.ashx?action=EditorFile&IsWater=1',
                fileManagerJson: '../Admin/tools/upload_ajax.ashx?action=ManagerFile',
